...
export const post: BlogPost = {
  ...
  content: [
    ...
    },
    {
      ...
      paragraphs: [],
      blocks: [
        { type: "paragraph", text: "The hackathon doesn't end when prizes are announced. The best outcomes happen in the next 48 hours. **Dispatch AI won the Grand Prize at the UC Berkeley AI Hackathon 2024**, worth $64K across prizes, including a $25K Berkeley SkyDeck Fund investment and a Golden Ticket to SkyDeck Pad-13 (devpost.com/software/dispatch-ai)." },
        { type: "step-list", steps: [
