  ...
  content: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "image", src: "/blog/berkeley-ai-hackathon-problem-slide.png", alt: "A dark pitch slide showing the problem: 82 percent of 911 call centers are understaffed, surrounded by emergency dispatch product visuals.", caption: "One memorable statistic, enough visual context to feel the pain point. The 82 percent figure comes from The Pulse of 9-1-1, the 2023 NENA and Carbyne State of the Industry Survey.", credit: "Slide courtesy of Bill Zhang." },
