...
export const PERSONA_RESULTS: Record<Persona, PersonaResult> = {
  designer: {
    ...
    weakness: "Perfectionism under time pressure, still learning when 'good enough' ships",
    bestMatch: "architect",
  ...
  strategist: {
    ...
    weakness: "Over-planning and rigidity, because sometimes the process needs to flex",
    bestMatch: "pitcher",
...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { text: "Start planning what to say if the demo is half-broken, since judges won't know what's missing", persona: "pitcher" },
  ...
  },
  {
    ...
    options: [
      { text: "Do a final polish pass to fix that button alignment and tweak the color scheme", persona: "designer" },
  ...
  },
  {
    ...
    options: [
      { text: "Get excited, because if it looks impressive in the demo, it's worth the risk", persona: "designer" },
      { text: "Think about whether it makes the pitch story stronger or just adds noise", persona: "pitcher" },
      { text: "Evaluate the technical complexity and whether it will break existing integrations", persona: "architect" },
  ...
  },
  {
    ...
    options: [
      { text: "Pull up the app and show them, because the interface speaks for itself", persona: "designer" },
      { text: "Give them the 30-second elevator pitch you've been rehearsing in your head", persona: "pitcher" },
      { text: "Explain the architecture, because how the pieces fit together is the impressive part", persona: "architect" },
  ...
  },
  {
    ...
    options: [
      { text: "Switch to the Figma mockups, since at least the design vision is clear", persona: "designer" },
      { text: "Smoothly pivot: 'Let me walk you through what you would have seen...'", persona: "pitcher" },
      { text: "Quickly diagnose the issue, since you might be able to fix it live", persona: "architect" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Time-box the debate to 10 minutes, then pick something and move on", persona: "strategist" },
    ],
  },
  {
    id: "q8",
